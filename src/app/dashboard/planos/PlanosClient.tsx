...
const PLANOS = [
  ...
  },
  {
    ...
    features: [
      ...
      { ok: true, texto: 'Ficha personalizada por categoria' },
      { ok: true, texto: 'Selo de verificado ⭐' },
      { ok: true, texto: 'Upload escudo / logo do time' },
      { ok: true, texto: 'Domínio personalizado' },
      { ok: true, texto: 'Analytics 1 ano' },
